            ...
            <div class="row">
              ...
              <div class="col">
                <div class="container">
                  <div class="row">
                    <div class="col">
                      <img src="phone.png" class="rounded d-block " alt="..." style="display: block;max-width: 35px;height: auto;">
                    </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="container">
                  <div class="row">
                    <div class="col">
                      <img src="email.png" class="rounded d-block " alt="..." style="display: block;max-width: 35px;height: auto;">
                    </div>
                    <div class="col">
